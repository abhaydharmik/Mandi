      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-white/6 rounded-2xl p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button type="submit" disabled={loading} className="w-full py-3 rounded-xl bg-orange-500 hover:bg-orange-400 text-white text-sm font-semibold transition-colors duration-150 mt-2 disabled:opacity-50">
        ...
        <p className="text-center text-gray-400 dark:text-neutral-600 text-sm mt-6">
          ...
          <Link to="/register" className="text-gray-700 dark:text-neutral-300 hover:text-gray-900 dark:hover:text-white transition-colors">Create one</Link>
        </p>
      </div>
    </div>
  );
