      ...
      <div className="max-w-5xl mx-auto px-6 pt-14 pb-24">
        ...
        <div className="flex items-end justify-between mb-10">
          <div>
            ...
            <h1 className="text-gray-900 dark:text-white text-4xl font-bold tracking-tight">Your Cart</h1>
        ...
        {cart.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-28 text-center">
            <div className="w-16 h-16 rounded-2xl bg-white dark:bg-neutral-900 border border-gray-200 dark:border-white/6 flex items-center justify-center mb-6">
              <svg className="w-7 h-7 text-gray-300 dark:text-neutral-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            <div className="lg:col-span-2 space-y-3">
              {cart.map((item) => (
                <div key={item.id} className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-white/6 rounded-2xl p-5 hover:border-gray-300 dark:hover:border-white/10 transition-colors duration-150">
                  <div className="flex gap-5">
                    <div className="w-20 h-20 rounded-xl bg-gray-50 dark:bg-white flex items-center justify-center shrink-0 p-2 border border-gray-100 dark:border-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between gap-4 mb-1">
                        ...
                        <button onClick={() => handleRemove(item.id)} className="text-gray-300 dark:text-neutral-600 hover:text-red-500 dark:hover:text-red-400 transition-colors shrink-0">
                          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                          </svg>
                        </button>
                      </div>
                      <p className="text-gray-400 dark:text-neutral-600 text-xs capitalize mb-4">{item.category}</p>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-900 dark:text-white text-sm font-semibold w-6 text-center tabular-nums">{item.quantity}</span>
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-gray-900 dark:text-white font-bold text-base">${(item.price * item.quantity).toFixed(2)}</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div>
              <div className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-white/6 rounded-2xl p-6 sticky top-20">
                <h2 className="text-gray-900 dark:text-white font-semibold mb-6">Order Summary</h2>
                ...
                <div className="border-t border-gray-100 dark:border-white/6 pt-4 flex justify-between items-center mb-6">
                  <span className="text-gray-900 dark:text-white font-semibold">Total</span>
                  <span className="text-gray-900 dark:text-white text-2xl font-bold tabular-nums">${total.toFixed(2)}</span>
                </div>
