    ...
    <div className="min-h-screen bg-gray-50 dark:bg-neutral-950">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-14 pb-24">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-gray-900 dark:text-white text-4xl font-bold tracking-tight">Products</h1>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          ...
          <select
            ...
            className="px-4 py-2.5 rounded-xl bg-white dark:bg-neutral-900 border border-gray-200 dark:border-white/[0.07] text-gray-700 dark:text-neutral-300 text-sm outline-none focus:border-orange-500/60 dark:focus:border-orange-500/40 transition-colors capitalize appearance-none cursor-pointer min-w-40"
          >
            {categories.map((cat) => (
        ...
        {!loading && !error && (
          <p className="text-gray-400 dark:text-neutral-600 text-xs mb-6 tabular-nums">
